    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (loggerGamepad.wasJustPressed(GamepadKeys.Button.CROSS)) {
                ...
                KoalaLog.log("Shoot fail - undershoot - speed", 0.5*(robot.shooter.getFlywheelMotorCurrentTicksPerSecond() + robot.shooter.getFlywheelMotor2CurrentTicksPerSecond()), false);
                ...
                KoalaLog.log("Shoot fail - overshoot - speed", 0.5*(robot.shooter.getFlywheelMotorCurrentTicksPerSecond() + robot.shooter.getFlywheelMotor2CurrentTicksPerSecond()), false);
            ...
            if (loggerGamepad.wasJustPressed(GamepadKeys.Button.CIRCLE)) {
                ...
                KoalaLog.log("Shoot fail - incorrect heading - speed", 0.5*(robot.shooter.getFlywheelMotorCurrentTicksPerSecond() + robot.shooter.getFlywheelMotor2CurrentTicksPerSecond()), false);
