...
public class CloseAutonomousNoPattern {
    LinearOpMode opMode;
    public boolean isBlue;

    public CloseAutonomousNoPattern(LinearOpMode opMode, boolean isBlue) {
        this.opMode = opMode;
        this.isBlue = isBlue;
    }
    public void run() throws InterruptedException {
        ...
        Vector2d shootPosition = new Vector2d(-24, -18 * isBlueValue);

        TrajectoryActionBuilder b_MoveToScanObelisk = drive.actionBuilder(startingPlace)
                .splineToSplineHeading(new Pose2d(shootPosition, Math.toRadians(150 * isBlueValue)), Math.toRadians(0));
        ...
        TrajectoryActionBuilder b_MoveToShootingPlace1 = b_MoveToCloseGate.endTrajectory().fresh()
                ...
                .splineToSplineHeading(new Pose2d(shootPosition, Math.toRadians(-135 * isBlueValue)), Math.toRadians(135 * isBlueValue));
